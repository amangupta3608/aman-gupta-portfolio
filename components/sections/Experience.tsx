...
export function Experience() {
  ...
  return (
    <section id="experience" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="relative ml-3 before:absolute before:left-[1px] before:top-0 before:h-full before:w-px before:bg-gradient-to-b before:from-indigo-500 before:via-cyan-400 before:to-emerald-400">
